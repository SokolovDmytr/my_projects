...
class CustomNavigationBottomBar extends StatelessWidget {
  ...
  List<Widget> _createListWidget(String image, Color color) {
  ...
  Widget build(BuildContext context) {
    final BottomNavigationBarLanguage _language =
        FlutterDictionary.instance.language?.bottomNavigationBarLanguage ?? en.bottomNavigationBarLanguage;
    return StoreConnector<AppState, NavigationBottomBarViewModel>(
      converter: NavigationBottomBarViewModel.init,
      builder: (BuildContext context, NavigationBottomBarViewModel vm) => Container(
        height: 88.0,
        child: Column(
          children: [
            Divider(
