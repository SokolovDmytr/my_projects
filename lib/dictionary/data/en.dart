...
Language en = Language(
  ...
  dialogLanguage: DialogLanguage(
    ...
    loadingText: 'loading...',
    forgotPasswordEmailTitle: 'Enter your email',
    forgotPasswordEmailHint: 'Email',
    forgotPasswordCodeTitle: 'We have sent a verification code to your email.Enter a code',
    forgotPasswordCodeHint: 'Code',
    forgotPasswordPasswordTitle: 'Enter a new password',
    forgotPasswordPasswordHint: 'Password',
    forgotPasswordConfirmPasswordHint: 'Confirm Password',
    forgotPasswordButtonShowPasswordText: 'Show',
    forgotPasswordButtonSendText: 'Send',
    forgotPasswordButtonSaveText: 'Save',
    removeRecipeFromFavouritesText: 'You want to remove this recipe from favourites?',
  ),
);
