...
Language ru = Language(
  ...
  settingsPageLanguage: SettingsPageLanguage(
    ...
    settings: 'Настройки',
    buttonNo: 'Нет',
    youSureWantToExit: 'Вы уверены, что хотите выйти из приложения',
    description:
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.',
  ...
  dialogLanguage: DialogLanguage(
    ...
    forgotPasswordEmailTitle: 'Введите адрес электронной почты',
    forgotPasswordEmailHint: 'Email',
    forgotPasswordCodeTitle: 'Мы отправили проверочный код на вашу электронную почту. Введите код',
    forgotPasswordCodeHint: 'Код',
    forgotPasswordPasswordTitle: 'Введите новый пароль',
    forgotPasswordPasswordHint: 'Пароль',
    forgotPasswordConfirmPasswordHint: 'Подтвердите пароль',
    forgotPasswordButtonShowPasswordText: 'Показать',
    forgotPasswordButtonSendText: 'Отправить',
    forgotPasswordButtonSaveText: 'Сохранить',
    removeRecipeFromFavouritesText: 'Вы хотите удалить этот рецепт из избранного?',
  ),
);
