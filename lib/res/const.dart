...
const String hiveBoxNameNotification = 'hiveBoxNameNotification';
const String userKey = 'admin';
const String secureNameKey = 'secureKey';
const String notificationKey = 'notificationKey';
const String patternForEmail = r"^[a-zA-Z0-9.a-zA-Z0-9.!#$%&'*+-/=?^_`{|}~]+@[a-zA-Z0-9]+\.[a-zA-Z]+";
const String titleOfNotification = 'title';
const String bodyOfNotification = 'body';
const String headOfNotification = 'notification';
