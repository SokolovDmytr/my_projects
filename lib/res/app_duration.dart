class AppDuration {
  ...
  static const Duration defaultDurationForSplashScreen = Duration(seconds: 3);
  static const Duration recipeOpenDuration = Duration(milliseconds: 300);
  static const Duration onBoardingScreenDuration = Duration(milliseconds: 300);
  ...
  static const Duration imageLifetime = Duration(minutes: 1);
  static const Duration fourSecond = Duration(seconds: 4);
  static const Duration zero = Duration();
  static const Duration oneHundredMilliseconds = Duration(milliseconds: 100);
}
